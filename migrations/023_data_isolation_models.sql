-- Phase 9: Data Isolation Models and Role-Based Permissions
-- Adds the isolation mode to the tenant and tracks ownership of all campaigns/contacts.
-- Includes backfilling existing rows to the tenant's owner so no data is hidden.
